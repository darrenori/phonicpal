...
const title = html.match(/<title>[\s\S]*?<\/title>/)?.[0] ?? '<title>PhonicPal</title>';
...
writeFileSync(join(dir, 'phonicpal.html'), page);
console.log(`artifact page: ${(page.length / 1024).toFixed(0)} KB -> dist-artifact/phonicpal.html`);
